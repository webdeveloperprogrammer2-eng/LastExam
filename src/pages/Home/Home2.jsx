...
const rawProducts = [
  { id: "tele-1", price: 2491, titleKey: "productTitleClassic", badgeKey: "badgeGift", images: image1 },
  { id: "tele-2", price: 3200, titleKey: "productTitleClassic", badgeKey: null, images: image2 },
  { id: "tele-3", price: 1345, titleKey: "productTitleClassic", badgeKey: null, images: image3 },
  { id: "tele-4", price: 2600, titleKey: "productTitleClassic", badgeKey: null, images: image4 },
  { id: "tele-5", price: 2890, titleKey: "productTitle30", badgeKey: "badgeNew", images: image5 },
  { id: "tele-6", price: 1980, titleKey: "productTitleFoil", badgeKey: null, images: image6 },
];
  ...
  return (
    <Box className="max-w-[1200px] mx-auto p-6">
      <div className="max-w-[1200px] m-auto p-[10px] flex justify-between items-center">
        <Typography variant="h5">{t('home2.heading')}</Typography>
        <Button
