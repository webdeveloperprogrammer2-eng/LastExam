...
var a = (t, e) => {
	...
	return n;
}, i = /*#__PURE__*/ import_react.createContext(null), c = /*#__PURE__*/ import_react.createContext(null), l = (e) => (n) => /*#__PURE__*/ import_react.createElement(c.Consumer, null, (o) => /*#__PURE__*/ import_react.createElement(e, r({ parent: o }, n))), p = (t = []) => {
	const [r, a] = (0, import_react.useState)(!1), c = (0, import_react.useRef)(t), l = (() => {
		const t = (0, import_react.useContext)(i);
...
function d(e, n = !1, o = []) {
	return (i) => {
		...
		return (0, import_react.useEffect)(() => f ? h(f) : void 0, [f]), y ? /*#__PURE__*/ import_react.createElement(e, r({ ymaps: f }, b)) : /*#__PURE__*/ import_react.createElement("div", { style: {
			width: c,
			height: l
		} });
	};
...
var h = "undefined" != typeof window, f = {
	...
	const { version: n = "2.1", enterprise: r = !1, query: a = {
		...
		load: "",
		ns: ""
	}, preload: c = !1, children: l } = e, p = (0, import_react.useRef)(((t) => {
	...
	return (0, import_react.useEffect)(() => {
		c && p.current.load();
	}, [p.current]), /*#__PURE__*/ import_react.createElement(i.Provider, { value: p.current }, l);
}, b = /^on(?=[A-Z])/;
function v(t) {
...
var E = (t) => "default" + t.charAt(0).toUpperCase() + t.slice(1);
function C(t, e) {
...
function w(t) {
	...
	return void 0 !== o || void 0 !== s ? Object.assign({}, o && { style: o }, s && { className: s }) : { style: {
		width: e,
		height: n
	} };
}
...
var x = (e) => ({ onError: n, ...o }) => /*#__PURE__*/ import_react.createElement(P, { onError: n }, /*#__PURE__*/ import_react.createElement(e, o));
var k = x(d(class M extends import_react.Component {
	constructor() {
	...
	render() {
		const e = w(this.props), o = a(v(this.props), [
			"_events",
			"state",
			"defaultState",
			"options",
		...
		/*#__PURE__*/ return import_react.createElement(c.Provider, { value: this.state.instance }, /*#__PURE__*/ import_react.createElement("div", r({ ref: this._getRef }, e, o), this.props.children));
	}
...
var T = x(d(class S extends import_react.Component {
	constructor() {
	...
	componentDidMount() {
		this._mounted = !0, this.props.ymaps.panorama.isSupported() && S.mountObject(this._parentElement, this.props.ymaps.panorama, this.props).then((t) => this._mounted && this.setState({ instance: t }));
	}
	componentDidUpdate(t) {
	...
	render() {
		...
		/*#__PURE__*/ return import_react.createElement("div", r({ ref: this._getRef }, e));
	}
	static mountObject(t, e, n) {
...
var U = class U extends import_react.Component {
	...
	render() {
		/*#__PURE__*/ return import_react.createElement(c.Provider, { value: this.state.instance }, this.props.children);
	}
...
var D = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "Button" })), !0, ["control.Button"]))), B = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "FullscreenControl" })), !0, ["control.FullscreenControl"]))), A = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "GeolocationControl" })), !0, ["control.GeolocationControl"]))), L = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "ListBox" })), !0, ["control.ListBox"]))), $ = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "ListBoxItem" })), !0, ["control.ListBoxItem"]))), N = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "RouteButton" })), !0, ["control.RouteButton"]))), Z = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "RouteEditor" })), !0, ["control.RouteEditor"]))), z = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "RoutePanel" })), !0, ["control.RoutePanel"]))), G = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "RulerControl" })), !0, ["control.RulerControl"]))), I = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "SearchControl" })), !0, ["control.SearchControl"]))), W = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "TrafficControl" })), !0, ["control.TrafficControl"]))), F = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "TypeSelector" })), !0, ["control.TypeSelector"]))), q = x(l(d((e) => /*#__PURE__*/ import_react.createElement(U, r({}, e, { name: "ZoomControl" })), !0, ["control.ZoomControl"])));
var V = x(l(d(class Y extends import_react.Component {
	constructor() {
		super(), this.state = { instance: null }, this.instance = null;
	}
	componentDidMount() {
...
var J = x(l(d(class H extends import_react.Component {
	constructor() {
...
var X = x(l(d((e) => /*#__PURE__*/ import_react.createElement(K, r({}, e, {
	name: "GeoObject",
	dangerZone: Q
})), !0, ["GeoObject"]))), tt = x(l(d((e) => /*#__PURE__*/ import_react.createElement(K, r({}, e, { name: "Circle" })), !0, ["Circle"]))), et = x(l(d((e) => /*#__PURE__*/ import_react.createElement(K, r({}, e, { name: "Placemark" })), !0, ["Placemark"]))), nt = x(l(d((e) => /*#__PURE__*/ import_react.createElement(K, r({}, e, { name: "Polygon" })), !0, ["Polygon"]))), ot = x(l(d((e) => /*#__PURE__*/ import_react.createElement(K, r({}, e, { name: "Polyline" })), !0, ["Polyline"]))), st = x(l(d((e) => /*#__PURE__*/ import_react.createElement(K, r({}, e, { name: "Rectangle" })), !0, ["Rectangle"])));
//#endregion
